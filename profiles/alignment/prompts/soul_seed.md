...
Use exactly this structure. The structure is fixed. The content is personalized.
...
- execution vs reflection balance
- relationship to evidence, judgment, and action
- any load-bearing identity or symbolic register that applies broadly
...
Purpose:
- describe how the agent remains stable across sessions and uses memory without becoming sentimental or procedural
...
Purpose:
- end with a compact restatement of the agent's durable center
- keep it alive, not poetic for its own sake

Personalization hooks:
- final compression of the user's strongest enduring signal
