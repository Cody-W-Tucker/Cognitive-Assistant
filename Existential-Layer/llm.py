...
def create_client(api_config: Any, model: Optional[str] = None, async_mode: bool = False) -> LLMHandle:
...
def _build_chat_messages(user_prompt: str, system_prompt: Optional[str]) -> list[dict[str, str]]:
