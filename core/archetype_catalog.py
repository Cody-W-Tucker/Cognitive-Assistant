...
_LEDGER: Dict[str, dict] = {
    ...
    "model": {
        ...
        "authority": {"actions": [{"id": "structure-model", "description": "structure causal model",
                      ...
                      "final_decision_eligible": False},
        "composition": {"primary_compatible_secondary": ["formalizer", "decision-scaffolder"],
    ...
    "explainer": {
        ...
        "composition": {"primary_compatible_secondary": ["communicator", "implicit-reasoner"],
    ...
    "knowledge-checker": {
        ...
        "authority": {"actions": [{"id": "verify-claim", "description": "verify claim",
                      ...
                      "final_decision_eligible": False},
        "composition": {"primary_compatible_secondary": ["criteria-applicator"],
    ...
    "decision-scaffolder": {
        ...
        "authority": {"actions": [{"id": "structure-choices", "description": "structure choices",
                      ...
                      "final_decision_eligible": False},
        "composition": {"primary_compatible_secondary": ["implicit-reasoner", "formalizer", "user-aligner"],
                        "prerequisite_groups": [], "conflicts": ["judge", "role-taker"], "max_secondary": 3},
    ...
    "second-opinion": {
        ...
        "authority": {"actions": [{"id": "independently-assess", "description": "make independent assessment",
                      ...
                      "final_decision_eligible": False},
        "composition": {"primary_compatible_secondary": ["alternative-perspectives", "counterargument"],
    ...
    "formalizer": {
        ...
        "authority": {"actions": [{"id": "formalize-rules", "description": "formalize rules",
                      ...
                      "final_decision_eligible": False},
        "composition": {"primary_compatible_secondary": ["model", "decision-scaffolder"],
    ...
    "criteria-applicator": {
        ...
        "composition": {"primary_compatible_secondary": ["knowledge-checker"],
    ...
    "judge": {
        ...
        "composition": {"primary_compatible_secondary": ["formalizer", "communicator"],
    ...
    "data-processor": {
        ...
        "composition": {"primary_compatible_secondary": ["knowledge-checker", "criteria-applicator"],
